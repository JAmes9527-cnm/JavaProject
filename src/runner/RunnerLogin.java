...
public class RunnerLogin extends javax.swing.JFrame {
    ...
    private void loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginActionPerformed
        // TODO add your handling code here:
        String runnerID = jTextField1.getText();
        String password = jTextField2.getText();
        Runner runner = new Runner(runnerID,password);
        if (runnerID.isEmpty()) {
            JOptionPane.showMessageDialog(null, "Please fill in the RunnerID");
        }
        else if(password.isEmpty()){
            JOptionPane.showMessageDialog(null, "Please fill in the password");
        }
        else if(runner.login()){
