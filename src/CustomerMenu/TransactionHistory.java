...
public class TransactionHistory extends javax.swing.JFrame {
    ...
    public void setTable(){
        Object[] trans = Transaction.getTransactions(CustomerLogin.customerID);
        model = new NonEditableTableModel();
        model.addColumn("Transaction Type");
        model.addColumn("Credit before");
        model.addColumn("Credit after");
        model.addColumn("Date");
        
        for(Object obj:trans){
            if(obj instanceof Transaction){
                Transaction tran = (Transaction) obj;
                model.addRow(new Object[]{tran.getTransactionType(),tran.getCreditBefore(),tran.getCreditAfter(),tran.getDate()});
            }
        }
