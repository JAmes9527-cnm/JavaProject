...
public class OrderStatus extends javax.swing.JFrame {
    ...
    public void setTable(){
        ...
        model.addColumn("Dine in / take away / delivery");
        model.addColumn("Food Status");
        model.addColumn("Delivery Status");
        model.addColumn("Status");
        String id = CustomerLogin.customerID;
        ...
        for(Object obj:Objectlist){
            if(obj instanceof OrderFile){
                ...
                if(order.getCustomerID().equals(id)&&order.getOrderStatus()!=OrderFile.OrderStatus.COMPLETED){
                    model.addRow(new Object[]{order.getOrderID(),order.getDate(),order.getEatWhere(),order.getFoodStatus(),order.getDelivery(),order.getOrderStatus()});
                }
            }
        }
