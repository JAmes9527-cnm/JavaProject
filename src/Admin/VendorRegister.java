...
public class VendorRegister extends javax.swing.JFrame {
     ...
     */
    private String[] columnName = {"ID","Name","Password"};
    ...
    private void deleteVendorMenuFile(String vendorID) {
    File menuFile = new File("menu/" + vendorID + "MENU.txt");
    if (menuFile.exists()) {
        if (menuFile.delete()) {
            System.out.println("Menu file for vendor " + vendorID + " deleted successfully.");
        } else {
            System.out.println("Failed to delete the menu file for vendor " + vendorID);
        }
    } else {
        System.out.println("Menu file for vendor " + vendorID + " does not exist.");
    }
}
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String vendorID = String.valueOf(model.getValueAt(row, 0));
        model.removeRow(row);
        deleteVendorMenuFile(vendorID);
        Cleartf();
        row = -1;
        saveToFile();
    ...
    private void saveToFile(){
            // TODO add your handling code here:
        try {
        BufferedWriter writer = new BufferedWriter(new FileWriter("vendor.txt"));
